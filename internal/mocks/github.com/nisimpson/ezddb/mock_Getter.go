...
func (_m *MockGetter) GetItem(_a0 context.Context, _a1 *dynamodb.GetItemInput, _a2 ...func(*dynamodb.Options)) (*dynamodb.GetItemOutput, error) {
...
// MockGetter_GetItem_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetItem'
type MockGetter_GetItem_Call struct {
	*mock.Call
}
...
func (_e *MockGetter_Expecter) GetItem(_a0 interface{}, _a1 interface{}, _a2 ...interface{}) *MockGetter_GetItem_Call {
	return &MockGetter_GetItem_Call{Call: _e.mock.On("GetItem",
		append([]interface{}{_a0, _a1}, _a2...)...)}
}

func (_c *MockGetter_GetItem_Call) Run(run func(_a0 context.Context, _a1 *dynamodb.GetItemInput, _a2 ...func(*dynamodb.Options))) *MockGetter_GetItem_Call {
...
func (_c *MockGetter_GetItem_Call) Return(_a0 *dynamodb.GetItemOutput, _a1 error) *MockGetter_GetItem_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGetter_GetItem_Call) RunAndReturn(run func(context.Context, *dynamodb.GetItemInput, ...func(*dynamodb.Options)) (*dynamodb.GetItemOutput, error)) *MockGetter_GetItem_Call {
	_c.Call.Return(run)
	return _c
}
